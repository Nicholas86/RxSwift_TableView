...
import Foundation
/// 基础接口
//let baseUrl = "http://192.168.3.99:8090/"//白
//let baseUrl = "http://192.168.3.154:8095/"
let baseUrl = "http://yundongcmbs.fangshangqu.com/"
let registerUrl = baseUrl + "sportcmbs/member/register.htm"//1.注册
let loginUrl = baseUrl + "sportcmbs/member/login.htm"//2.登录
...
let forgetPasswordUrl = baseUrl + "sportcmbs/member/forgetPassword.htm"//5.忘记密码
